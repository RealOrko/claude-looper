/**
 * fix-plan-generator.js - Fix plan generation for the Tester agent
 *
 * Contains the DetailedFixPlan class that provides structured feedback
 * to the Coder agent for fixing issues found during testing.
 */
 ...
 * @param {Object} issue - Issue object with description
...
/**
 * Fix suggestion templates by issue category
 */
export const FixSuggestionTemplates = {
  ...
  [IssueCategory.CODE_QUALITY]: 'Refactor to improve code quality and maintainability',
};
 ...
 */
export function generateSuggestedFix(category, description) {
  return FixSuggestionTemplates[category] || `Address the ${category} issue: ${description}`;
}
